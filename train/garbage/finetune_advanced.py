...
FINETUNED_MODEL_PATH = "model/rotation_finetuned_advanced.pth"
...
train_indices, val_indices = train_test_split(
    indices, test_size=VALIDATION_SPLIT, random_state=42, stratify=None # 如果标签不均衡，可以考虑stratify
)
...
# 创建训练和验证数据集
train_dataset = CustomImageDataset(image_paths=train_paths, transform=fine_tune_transform)
val_dataset = CustomImageDataset(image_paths=val_paths, transform=fine_tune_transform)
